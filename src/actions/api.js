...
const _self = {
  ...
  addMenuItem(name, altName, price, restaurantId, cb) {
    return fetch(`${baseURL()}/menu/new/${restaurantId}`, {
        credentials: "same-origin",
        method: 'POST',
        body: JSON.stringify({
          name: name,
      ...
      .catch((error) => {
        console.log('There has been a problem with your fetch operation - add new item: ' + error.message)
        return error
      })
  }
}
