...
module.exports = {
  notificationTest(action, expectedAction) {
    expect(action).to.have.property('type').and.equal(expectedAction.type)

    expect(action).to.have.property('message').and.equal(expectedAction.message)

    expect(action).to.have.property('title').and.equal(expectedAction.title)
    expect(action).to.have.property('position').and.equal(expectedAction.position)
    expect(action).to.have.property('level').and.equal(expectedAction.level)
    expect(action).to.have.property('autoDismiss').and.equal(expectedAction.autoDismiss)
